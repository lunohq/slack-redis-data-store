...
var SlackRedisDataStore = function (_SlackDataStore) {
  ...
  function SlackRedisDataStore(opts) {
    ...
    _this.getChannelOrGroupByName = function () {
      var _ref28 = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee28(name) {
        var channel;
        return _regenerator2.default.wrap(function _callee28$(_context28) {
          while (1) {
            switch (_context28.prev = _context28.next) {
              ...
              case 2:
                channel = _context28.sent;
                return _context28.abrupt('return', channel || _this.getGroupByName(name));
    ...
    _this.userKeyName = dataStoreOpts.userKeyName || 'user';
    _this.userByNameKeyName = dataStoreOpts.userByNameKeyName || 'user.name';
    _this.userByEmailKeyName = dataStoreOpts.userByEmailKeyName || 'user.email';
    _this.userByBotIdKeyName = dataStoreOpts.userByBotIdKeyName || 'user.botId';
    _this.channelKeyName = dataStoreOpts.channelKeyName || 'channel';
    _this.channelByNameKeyName = dataStoreOpts.channelByNameKeyName || 'channel.name';
    _this.dmKeyName = dataStoreOpts.dmKeyName || 'dm';
    _this.dmByUserIdKeyName = dataStoreOpts.dmByUserIdKeyName || 'dm.userId';
    _this.groupKeyName = dataStoreOpts.groupKeyName || 'group';
    _this.groupByNameKeyName = dataStoreOpts.groupByNameKeyName || 'group.name';
    _this.botKeyName = dataStoreOpts.botKeyName || 'bot';
    _this.botByNameKeyName = dataStoreOpts.botByNameKeyName || 'bot.name';
    _this.teamKeyName = dataStoreOpts.teamKeyName || 'team';
  ...
  (0, _createClass3.default)(SlackRedisDataStore, [{
    ...
    value: function setBot(bot) {
      ...
      return multi.hset(this.botKeyName, bot.id, this.serialize(bot)).hset(this.botByNameKeyName, bot.name, bot.id).execAsync();
    }
  }, {
    key: 'setTeam',
